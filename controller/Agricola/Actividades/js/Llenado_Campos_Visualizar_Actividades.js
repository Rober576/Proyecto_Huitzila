    ...
    if (dataString) {
        ...
        for (let i = 0; i < data.reporteactividad.length; i++) {
            let Nombre = data.reporteactividad[i].NombreTrabajador;
            let lunes = data.reporteactividad[i].Lunes;
            let martes = data.reporteactividad[i].Martes;
            let miercoles = data.reporteactividad[i].Miercoles;
            let jueves = data.reporteactividad[i].Jueves;
            let viernes = data.reporteactividad[i].Viernes;
            let sabado = data.reporteactividad[i].Sabado;
            let NoSemanas = 'Semana ' + data.reporteactividad[i].NoSemana;
            let Actividad = data.reporteactividad[i].ActividadDesarrollada;
            let Gas = parseFloat(data.reporteactividad[i].Gasolina) || 0;
            let Vehiculo = data.reporteactividad[i].Vehiculos;
...
// Retrasar la ejecución 2 segundos
setTimeout(ejecutarConRetraso, 1500);
