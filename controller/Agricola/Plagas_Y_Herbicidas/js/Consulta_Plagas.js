function buscar_datos(consulta) {
    var url = '../../../controller/Agricola/Plagas_Y_Herbicidas/php/Consulta_Plagas.php';
...
function EventoEditar() {
    ...
    for (var j = 0; j < botonesModificar.length; j++) {
        botonesModificar[j].addEventListener('click', function(e) {
            ...
            fetch('../../../controller/Agricola/Plagas_Y_Herbicidas/php/Modificar_Datos_Plagas.php?id=' + id, {
                method: 'GET',
            })
            ...
            .then(function(data) {
                ...
                window.location.href = '../../../view/Agricola/Plagas_y_herbicidas/Editar_Plagas.html';
            })
...
function confirmacion(e, id) {
    ...
    if (confirm('¿Estás seguro de eliminar el registro?')) {
        ...
        fetch('../../../controller/Agricola/Plagas_Y_Herbicidas/php/Eliminar_Plagas.php?id=' + id, {
            method: 'GET',
        })
        .then(res => res.json())
        .then(data => {
