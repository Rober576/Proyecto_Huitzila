...
if ($resultado) {
    ...
    foreach ($resultado as $fila) {
        ...
        $salida .= ' | ';
        $salida .= '<a href="../../view/ejemplo/Mod_Equipo4.html" class=".table_item__link.obtener-informacion" data-id="' . $id . '">Editar</a>';
        $salida .= '</td>';
...
<script src="../../controller/ejemplo/js/Eliminar_Equipo4.js"></script>
<script src="../../controller/ejemplo/js/Modificar2_Equipo4.js"></script>